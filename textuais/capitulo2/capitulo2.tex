...
Exemplo: \Verb+\autor{Alexandre Barbosa de Almeida}{ALMEIDA, A. B.}{M}+, note que o nome de citação deve conter os pontos finais nas abreviações \{ALMEIDA, A.B.\} e o sexo aceita duas opções: \{M\} (masculino) e \{F\} (feminino).
